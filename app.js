...
const translations = {
    nl: {
        ...
        event2Text: "Terug in het Warandepark – de thuisbasis – brengt Summer Jam opnieuw een dag vol urban sports en muziek. Verwacht een skatecontest, graffiti-jam, 3on3 basketbal, breakdance, freerunning en kinderanimatie. ’s Avonds sluiten we af met een spectaculaire feest in het park.",
    ...
    en: {
        ...
        event2Text: "Back in Warande Park – our home base – Summer Jam brings another day of urban sports and music. Expect a skate contest, graffiti jam, 3-on-3 basketball, breakdance, freerunning, and kids entertainment. In the evening, we wrap up with a spectacular party in the park.",
        event3Title: "Barbecrew",
        event3Date: "September, 2025",
